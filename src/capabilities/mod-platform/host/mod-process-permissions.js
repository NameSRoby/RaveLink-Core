// [TITLE] Module: capabilities/mod-platform/host/mod-process-permissions.js
// [TITLE] Purpose: build fail-closed Node permission flags for a third-party mod process
...
function buildModProcessPermissions(options = {}) {
